	...
	<?php
		$cosa_busca = strtolower($_REQUEST['busqueda']);
		if(empty($cosa_busca))
		{
		...
		<table class="table table-bordered">
			...
			<tbody>
				<?php
					...
					WHERE pai_id like '%$cosa_busca%' or pai_nom like '%$cosa_busca%' or pai_des like '%$cosa_busca%'");
					...
					WHERE pai_id like '%$cosa_busca%' or pai_nom like '%$cosa_busca%' or pai_des like '%$cosa_busca%'
					order by (pai_nom) asc limit $desde,$por_pagina ";
